...
export class TableAccount {
     ...
     * @returns {Promise<import("../models/Account.js").Account>} - The account object if the login is valid
     */
     ...
     * @returns {Promise<import("../models/Account.js").Account>} - The account object if the token is valid
     */
