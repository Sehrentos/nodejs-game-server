...
export class Client extends Entity {
    ...
    constructor(world, socket, req) {
        ...
        // console.log(`WS ${process.pid} new client connection`, this.urlFrom, this.urlTo, this.id);
    ...
    /**
     * Called when a new WebSocket message is received from the client
    ...
    onClose() {
        console.log(`Client ${process.pid} connection closed.`);
    ...
    async onTick(startTime) {
        ...
        // update client data on server update tick
    ...
    async onLogin(json) {
        ...
        console.log(`Client ${this.id} joined ${map.name}`)
        this.onEnterMap(map)
        return true
    }
    ...
    /**
     * Called when the client enters a map.
     * @param {WorldMap} map - The map the client is entering
     */
    onEnterMap(map) {
        this.map = map
