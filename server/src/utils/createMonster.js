 ...
 * @param {import("../../../shared/models/WorldMap.js").WorldMap} map - The map to use as reference.
 * @param {number} quantity - The quantity of monsters to create
 * @param {import("../../../shared/models/Entity.js").TEntityProps} monster - The monster to add.
